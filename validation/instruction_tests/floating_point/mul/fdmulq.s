...
!	or %l1, %l0, %l0
	...
	!instruction = FdMULq
	!basic case: 2.0(double) * 3.0(double) = 6.0(quad)
	set A, %l0
	ldd [%l0], %f0		! f0:f1 = 2.0 (double)
	set B, %l1
	ldd [%l1], %f2		! f2:f3 = 3.0 (double)
	fdmulq %f0, %f2, %f8	! f8-f11 = 6.0 (quad)
...
not_reached:
	...
	.align 8
A: .word 0x40000000, 0x00000000
B: .word 0x40080000, 0x00000000
