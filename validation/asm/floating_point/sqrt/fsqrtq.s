...
!	or %l1, %l0, %l0
	...
	!instruction = FSQRTq
	!basic case: sqrt(4.0) = 2.0
	set A, %l0
	ld [%l0], %f0
	ld [%l0+4], %f1
	ld [%l0+8], %f2
	ld [%l0+12], %f3	! f0-f3 = 4.0 (quad)
	fsqrtq %f0, %f8		! f8-f11 = 2.0 (quad)
	rd %psr, %o1		! Expected o1=0x10E0

	!invalid case: sqrt(-1.0) -- traps, g2 -> 1
	set B, %l1
	ld [%l1], %f12
	ld [%l1+4], %f13
	ld [%l1+8], %f14
	ld [%l1+12], %f15	! f12-f15 = -1.0 (quad)
	fsqrtq %f12, %f16	! invalid: sqrt(-1.0)
...
not_reached:
	...
	.align 8
mFSR: .word 0
A: .word 0x40010000, 0x00000000, 0x00000000, 0x00000000
B: .word 0xbfff0000, 0x00000000, 0x00000000, 0x00000000
