...
!	or %l1, %l0, %l0
	...
	fmulq %f0, %f4, %f8	! f8-f11 = 6.0 (quad)
	rd %psr, %o1		! Expected o1=0x10E0

	!invalid case: 0 * infinity -- traps, g2 -> 1
	set C, %l2
	ld [%l2], %f12
	ld [%l2+4], %f13
	ld [%l2+8], %f14
	...
	fmulq %f12, %f16, %f20	! invalid: 0 * inf
...
D: .word 0x7fff0000, 0x00000000, 0x00000000, 0x00000000
