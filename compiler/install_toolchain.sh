...
#
# Unpacks the prebuilt sparc-elf cross-assembler/linker/readelf/objdump/gcc
# (see README.md for exact versions, source citation, and platform support)
...
chmod +x toolchain/bin/* toolchain/libexec/gcc/sparc-elf/*/cc1
