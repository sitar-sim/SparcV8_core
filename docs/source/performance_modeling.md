...
| **Annulled instructions**<br>(`annulledInstructions`) | [`SparcCoreStats`](https://github.com/sitar-sim/SparcV8_core/blob/main/model/cpp_common_code/SparcCoreStats.h) | core_only/cpp, core_only/sitar, core_mmu/cpp, core_mmu/sitar | The number of not-taken annulling branches whose delay-slot instruction was fetched but never executed (Appendix B.4's `a` bit). |
