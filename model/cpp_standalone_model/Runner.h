...
//C++ and this repository's cpp_code/ library.
//
...
//trap logic, nothing Runner-specific about it.
//
//Runner itself has no notion of "success" or "failure" -- it only tracks
//whether the core halted (entered error_mode) and how many cycles that
//took. Test programs signal completion by halting (typically via a
...
{
	public:
		Runner(SparcCore& core, MemCore& mem);
